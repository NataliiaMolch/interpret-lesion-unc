...
uncs_measures = ['confidence', 'entropy_of_expected', 'expected_entropy', 'mutual_information', 'epkl',
                     'reverse_mutual_information']
uncs_measures_names = {
    'confidence': 'NC', 'entropy_of_expected': 'EoE', 'expected_entropy': 'ExE', 'mutual_information': 'MI',
    'epkl': 'EPKL', 'reverse_mutual_information': 'RMI'
}
